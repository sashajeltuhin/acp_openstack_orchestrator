#ps1_sysnative
$domainPass = "cisco.123"
$domainAdmin = "Administrator"
$domainName = "acplab"
$domainSuf = "local"
$LocalAdmin = "Administrator"
$platformadmin = "apprendaadmin"
$platformsystem = "apprendasystem"
$dcip = "192.168.0.102"
$dcname = "acp-dc"
...
"$($localIP.IPAddress) `t`t apprenda.ecatsrtpdmz.cisco.com" | Out-File -encoding ASCII -append $file
...
$webClient.DownloadFile("http://docs.apprenda.com/sites/default/files/Apprenda-7.0.0.zip","C:\builder\temp\apprenda-7.0.0.zip") | Out-Null
[System.IO.Compression.ZipFile]::ExtractToDirectory("c:\builder\temp\apprenda-7.0.0.zip", "c:\Apprenda") | Out-Null
